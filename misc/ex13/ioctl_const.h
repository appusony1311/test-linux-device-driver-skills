#ifndef _SAMPLE_CHAR_DEVICE_H_
#define _SAMPLE_CHAR_DEVICE_H_
...
/* SAMPLE_FILL_ZERO: to fill our character array with zeros
...
*/
#define SAMPLE_FILL_ZERO		_IO( SAMPLE_MAGIC, 1 )

/* SAMPLE_FILL_ZERO: to fill our character array with a character
   As we can see there is not data transfer. The moment
   our driver gets this command, it executes the following
   for loop
...
*/
#define SAMPLE_FILL_CHAR	_IOW(  SAMPLE_MAGIC, 2, char )

/* SAMPLE_GET_SIZE: to get the size of the character array */
#define SAMPLE_GET_SIZE		_IOR(  SAMPLE_MAGIC, 3, uint )

#define SAMPLE_MAX_CMDS		3

#endif /* _SAMPLE_CHAR_DEVICE_H_ */
